...
//this class is responsible to persist the event store 
@Injectable()
export class MongoEventStore implements EventStore{
    ...
    async persist(
        ...
        try {
            ...
            if (error?.code === UNIQUE_CONSTRAINT_ERROR_CODE) {
                this.logger.error(`Events could not be persisted. Aggregate is state`);
    ...
    //add another method to get event store 
